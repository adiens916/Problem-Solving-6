...
public class GarageModel extends AbstractModel<GarageDataClass> {
	...
	String getCreateQuery(GarageDataClass garage) {
		return "insert into garage(garage_id,g_name,g_address,g_number,g_manager,g_email)" + " values('" + garage.id
				+ "','" + garage.name + "','" + garage.address + "','" + garage.number + "','" + garage.manager + "','"
				+ garage.emailAddress + "')";
	}
	...
	String getUpdateQuery(GarageDataClass garage) {
		return "update garage " + "set g_name='" + garage.name + "',g_address='" + garage.address + "',g_number='"
				+ garage.number + "',g_manager='" + garage.manager + "',g_email='" + garage.emailAddress
	...
	@Override
	ArrayList<GarageDataClass> toInfoFromResultSet(ResultSet resultSet) throws SQLException {
